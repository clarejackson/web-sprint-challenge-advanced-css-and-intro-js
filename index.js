...
let century20s = [];
  for (let i = 0; i < array.length; i++){
    if ((array[i].years) >= century){
      century20s.push(array[i].name);
    }
  } return century20s;
}
console.log(get20s(artists, "1900 - 1900"));
...
function addArtist(array){
    array.push({"id": 20, "name": "Clare Jackson", "years": "1982 - current day", "genre": "Web Design", "nationality": "American", "bio": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."});
    return array;
  }
